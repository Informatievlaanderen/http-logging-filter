...
Target.create "Lib_Build" (fun _ ->
    buildSource "Be.Vlaanderen.Basisregisters.AspNetCore.Mvc.Logging"
)

Target.create "Lib_Publish" (fun _ -> publishSource "Be.Vlaanderen.Basisregisters.AspNetCore.Mvc.Logging")
